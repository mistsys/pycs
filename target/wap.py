...
gpio_cfg = (
  ('P0.0', None, None, None, None, None, 'XTAL_1',),
  ('P0.1', None, None, None, None, None, 'XTAL_2',),
  ...
  ('P0.6', None, None, None, None, None, 'UART_CTS',),
  ('P0.7', None, None, None, None, None, 'UART_TXD',),
  ('P0.8', None, None, None, None, None, 'UART_RXD',),
...
class target(object):
  """nRF52832- Nordic nRF52 SOC for WAP"""
